...
![Wi-Fi access point list showing `kiwi-ap`]({{ '/assets/media/kiwi-plotter/kiwi-plotter-connect-wifi.png' | relative_url }}){: style="width: 60%" }
...
{: .callout-tip }
![Kiwi Plotter device list showing a connected Kiwi device]({{ '/assets/media/kiwi-plotter/kiwi-plotter-connected.png' | relative_url }}){: style="width: 60%" }
...
![Kiwi Plotter tab showing real-time sensor measurements]({{ '/assets/media/kiwi-plotter/kiwi-plotter-device.png' | relative_url }}){: #fig-kiwi-plotter-device style="width: 60%" }
...
![Kiwi Plotter panel reorganization and 3-D visualization]({{ '/assets/media/kiwi-plotter/kiwi-plotter-reorganize.png' | relative_url }}){: style="width: 60%" }
...
![Instantaneous values shown on hover]({{ '/assets/media/kiwi-plotter/kiwi-plotter-instantaneous-value.png' | relative_url }}){: style="width: 60%" }
