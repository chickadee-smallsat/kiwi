...
#let tids(
  ...
  let backcover_page() = [
    ...
    The Kiwi Development team, the Lowell Center for Space Science and Technology, and University of Massachusetts Lowell (the Parties) has made every effort to ensure the accuracy and reliability of the information contained in this document. However, the information is provided "as is" without warranty of any kind, either expressed or implied. The Parties expressly disclaims all implied warranties including warranties of merchantability or of fitness for a particular purpose. In no event shall the Parties be liable for any damages arising out of or in connection with the use or performance of this document.
  ]
